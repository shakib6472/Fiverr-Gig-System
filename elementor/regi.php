            ...
            <div class="card p-5">
                ...
                <form id="registration_form" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="expertise">Your Subjects</label>
                            <select class="form-control" id="expertise" name="expertise[]" multiple="multiple" required>
                                <option disabled value="">Choose your expertise</option>
                                <?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" id="grade" name="grade[]" multiple="multiple" required>
